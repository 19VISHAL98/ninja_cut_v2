    ...
    try {
        ...
        switch (key) {
            case "DEBIT":
                ...
                obj.description = `${bet_amount} debited for Ninja Cut game for Round ${matchId}`;
                obj.bet_id = matchId;
                obj.txn_type = 0;
                break;
            ...
            case "CREDIT":
                ...
                obj.description = `${winning_amount} credited for Ninja Cut game for Round ${matchId}`;
                obj.txn_type = 1;
                break;
